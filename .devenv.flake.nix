{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/user/myapp";
  project_input_ref = "path:/home/user/myapp";
  devenv_dotfile = "/home/user/myapp/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/tmp";
  devenv_runtime = "/tmp/devenv-1e7221d";
  devenv_istesting = false;
  devenv_direnvrc_latest_version = 1;
  container_name = null;
  active_profiles = [
  ];
  hostname = "firebase-arbitrage-1771170545376";
  username = "user";
